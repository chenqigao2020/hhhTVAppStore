...
"CREATE TABLE IF NOT EXISTS `{$db_pre}app` (
  ...
  `app_watch_for_minutes` int(10) DEFAULT '5' COMMENT '试看分钟',
  `ui_use_source` varchar(10240) DEFAULT '' COMMENT '指定使用的源',
  PRIMARY KEY (`id`),
...
,
"CREATE TABLE IF NOT EXISTS `{$db_pre}classify` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT NULL COMMENT '分类名',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;"
,
"CREATE TABLE IF NOT EXISTS `{$db_pre}application` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL COMMENT '名称',
  `only` varchar(255) NOT NULL COMMENT '唯一标识,举例:apk的包名',
  `icon` varchar(1024) NOT NULL COMMENT '图标链接',
  `download` varchar(1024) NOT NULL COMMENT '安装包链接',
  `version` varchar(255) NOT NULL COMMENT '版本',
  `size` varchar(255) NOT NULL COMMENT '安装包大小',
  `details` varchar(10240) NOT NULL COMMENT '描述',
  `classify_id` int(10) NOT NULL COMMENT '分类id',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;"
]
?>
...
if ($act == 'edit') { //编辑应用
	...
	$update['app_watch_for_minutes'] = isset($_POST['app_watch_for_minutes']) ? intval($_POST['app_watch_for_minutes']) : '';
	$update['ui_use_source'] = isset($_POST['ui_use_source']) ? purge($_POST['ui_use_source']) : '';
